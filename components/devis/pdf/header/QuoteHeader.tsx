  ...
  return (
    <>
      ...
      <div {...blockProps("client")}>
        <DisplayInfos is_client default_gap={defaultGap} font_size={font_size} />
      </div>
    </>
  );
}

function createBlockProps(quote: ReturnType<typeof useQuote>["quote"], getDragProps?: HeaderDragProps) {
  return (
